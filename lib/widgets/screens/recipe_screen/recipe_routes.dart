...
import 'package:recipath/widgets/screens/recipe_screen/create_recipe_screen/recipe_history_screen.dart';
...
class RecipeRoutes {
  ...
  static GoRoute recipeHistory = GoRoute(
    path: "recipeHistory",
    builder: (context, state) =>
        RecipeHistoryScreen(recipeId: state.uri.queryParameters[idParameter]),
  );
