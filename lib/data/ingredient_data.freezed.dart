...
mixin _$IngredientData {
 ...
 double get amount; UnitEnum get unit; String get groceryId;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IngredientData&&(identical(other.amount, amount) || other.amount == amount)&&(identical(other.unit, unit) || other.unit == unit)&&(identical(other.groceryId, groceryId) || other.groceryId == groceryId));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,amount,unit,groceryId);

@override
String toString() {
  return 'IngredientData(amount: $amount, unit: $unit, groceryId: $groceryId)';
}
...
@useResult
$Res call({
 double amount, UnitEnum unit, String groceryId
});
...
/// Create a copy of IngredientData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? amount = null,Object? unit = null,Object? groceryId = null,}) {
...
class _IngredientData implements IngredientData {
  const _IngredientData({required this.amount, required this.unit, required this.groceryId});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IngredientData&&(identical(other.amount, amount) || other.amount == amount)&&(identical(other.unit, unit) || other.unit == unit)&&(identical(other.groceryId, groceryId) || other.groceryId == groceryId));
}
...
/// Create a copy of IngredientData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? amount = null,Object? unit = null,Object? groceryId = null,}) {
