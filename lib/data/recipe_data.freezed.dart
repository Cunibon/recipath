...
mixin _$RecipeData {
 ...
 String get id; String get title; String? get imageName; bool get archived; List<RecipeStepData> get steps;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,imageName,archived,const DeepCollectionEquality().hash(steps));

@override
String toString() {
  return 'RecipeData(id: $id, title: $title, imageName: $imageName, archived: $archived, steps: $steps)';
}
...
@useResult
$Res call({
 String id, String title, String? imageName, bool archived, List<RecipeStepData> steps
});
...
/// Create a copy of RecipeData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? imageName = freezed,Object? archived = null,Object? steps = null,}) {
...
class _RecipeData implements RecipeData {
  const _RecipeData({required this.id, required this.title, this.imageName, this.archived = false, required final  List<RecipeStepData> steps}): _steps = steps;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,imageName,archived,const DeepCollectionEquality().hash(_steps));
...
/// Create a copy of RecipeData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? imageName = freezed,Object? archived = null,Object? steps = null,}) {
